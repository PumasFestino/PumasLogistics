...
from yolo_lid.msg import StringArray, PointArray
import logging
...
class YoloCategoryNode:
    def __init__(self):
        ...
        # Cambié el nombre del tópico para evitar conflictos y puse el tipo correcto
        self.centroid_pub = rospy.Publisher("/vision/lid_centroids_array", PointArray, queue_size=10)
    ...
    def image_callback(self, msg):
        ...
        if len(all_boxes) > 0:
            ...
            for i in range(len(all_boxes)):
                ...
                p.z = float(all_boxes[i][5])  # Clase detectada como float para evitar error de tipo
